...
export const getServerSideProps = async() => {
    ...
    const res = await fetch(`https://newsapi.org/v2/${request.science.url}`)
...
function Science( {data}: InferGetServerSidePropsType<typeof getServerSideProps>){
    if(!data){
        return(
                        ...
                        <Row>
                            ...
                            <Col xxl={14} xl={14} lg={18} xs={20} md={18} sm={18} style={{ textAlign: "center" }}>
                                <div>
                                    ...
                                    <Title level={5} data-aos="zoom-out" data-aos-delay="200" data-aos-once style={{ paddingTop: "10px" }}>SCIENCE</Title>
                                </div>
                            </Col>
                            <Col xxl={5} xl={5} lg={3} xs={2} md={3} sm={3} />
                        </Row>
